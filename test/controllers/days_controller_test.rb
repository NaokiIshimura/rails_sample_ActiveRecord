...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { day: @day.day, state: @day.state, transportation: @day.transportation } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { day: @day.day, state: @day.state, transportation: @day.transportation } }
